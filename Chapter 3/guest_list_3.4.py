...
print(f"{guest_list[2]}, I will definitely get you some Culvers if you can get me an autographed jersey.")
print(f"Hey {guest_list[3]}, I love the Jordan 4s you did. Let's grab lunch and discuss the design phase")
print(f"{guest_list[4]}, you're definitely a big inspiration to me. Would love the opportunity to take you out to lunch sometime.")